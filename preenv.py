...
datas = {
    "condition": {"fn": "condition.txt", "parser": "initStatus"},
    "diaper_status": {"fn": "diaper_status.txt", "parser": "initStatus"},
    "health_status": {"fn": "health_status.txt", "parser": "initStatus"},
    "meal_type": {"fn": "meal_type.txt", "parser": "initStatus"},
    "nap_status": {"fn": "nap_status.txt", "parser": "initStatus"},
    "perform_detail": {"fn": "perform_detail.txt", "parser": "initStatus"},
...
tbn_fn = {
    "condition": {'f1': 'status', 'f2': 'status_chs'},
    "diaper_status": {'f1': 'status', 'f2': 'status_chs'},
    "health_status": {'f1': 'status', 'f2': 'status_chs'},
    "meal_type": {'f1': 'meal_type', 'f2': 'meal_type_chs'},
    "nap_status": {'f1': 'napquality', 'f2': 'napquality_chs'},
    "perform_detail": {'f1': 'detail', 'f2': 'detail_chs'}
}
...
def initDB(logger):
    ...
    if not dbn in dbs:
        ...
        cur.execute(
            "CREATE SCHEMA `{dbname}` DEFAULT CHARACTER SET utf8mb4 ;".format(dbname=dbn))
